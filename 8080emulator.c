...
int Emulate8080Op(State8080* state)
{
    ...
    switch(*opcode)
    {
        ...
        case 0x48: state->c = state->b; break;  //MOV B,B
        case 0x49: state->c = state->c; break;  //MOV B,C
        case 0x4a: state->c = state->d; break;  //MOV B,D
        case 0x4b: state->c = state->e; break;  //MOV B,E
        case 0x4c: state->c = state->h; break;  //MOV B,H
        case 0x4d: state->c = state->l; break;  //MOV B,L
        case 0x4e:          //MOV C,M
            uint16_t offset = (state->h << 8) | (state->l);
            state->c = state->memory[offset];
            break;
        case 0x4f: state->c = state->a; break;  //MOV C,A
        case 0x50: state->d = state->b; break;  //MOV B,B
        case 0x51: state->d = state->c; break;  //MOV B,C
        case 0x52: state->d = state->d; break;  //MOV B,D
        case 0x53: state->d = state->e; break;  //MOV B,E
        case 0x54: state->d = state->h; break;  //MOV B,H
        case 0x55: state->d = state->l; break;  //MOV B,L
        case 0x56:          //MOV D,M
            uint16_t offset = (state->h << 8) | (state->l);
